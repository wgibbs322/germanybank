                    ...
                    if (userConfirmedSoftcode.isConfirmed) {
                        ...
                        try {
                            ...
                            if (response.ok) {
                                ...
                                const transactionResponse = await fetch('https://ubsbackend.onrender.com/api/addtransaction', {
                                    method: 'POST',
                                    headers: {
                                        'Content-Type': 'application/json',
                                    },
                                    body: JSON.stringify({
                                        ...
                                        amount: -amountInUSD, // Negative for withdrawal
                                        status: 'Processing',
                                    }),
                                });
                                ...
                                if (transactionResponse.ok) {
                                    ...
                                    throw new Error(transactionData.error || 'Error adding transaction');
                                }
                            } else {
